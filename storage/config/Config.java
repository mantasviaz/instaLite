...
public class Config {
    ...
    public static final String S3_BUCKET_NAME = "images-upenn-nets2120-2024sp-leftovers";
    //public static final String DYNAMO_TABLE_NAME = "imdb-data";
    //public static final String CHROMA_DB_NAME = "imdb-photos";
    //public static final String CHROMA_BUCKET_NAME = "imdb-chroma-upenn-nets2120-2024sp-mantasviaz";
